        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white/70 backdrop-blur-md rounded-3xl border border-rose-100/60 shadow-sm p-8 md:p-10">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">{t.formTitle}</h2>
              <p className="text-sm text-gray-400 mb-8">{t.formDescription}</p>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1.5">{t.yourName}</label>
                    <input
                      type="text"
                      name="name"
                      value={form.name}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1.5">{t.emailAddress}</label>
                    <input
                      type="email"
                      name="email"
                      value={form.email}
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1.5">{t.message}</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-3xl border border-rose-100/60 shadow-sm p-8">
              <h3 className="text-lg font-bold text-gray-800 mb-4">{t.faqTitle}</h3>
            ...
            <div className="bg-linear-to-br from-rose-50 via-amber-50/60 to-pink-50 rounded-3xl border border-rose-100/60 shadow-sm p-8 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-1">{t.followTitle}</h3>
              <p className="text-xs text-gray-400 mb-5">{t.followDescription}</p>
